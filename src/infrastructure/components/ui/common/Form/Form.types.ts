...
import type { ISanitizeOptions } from '@infra/components/ui/common/Form/Form.types';
import type { ISecurityEvent } from '@infra/components/ui/common/Form/Form.types';
import type { IValidationRules } from '@infra/components/ui/common/Form/Form.types';
...
export type TInputVariant = 'outlined' | 'filled' | 'ghost';
...
interface IInputBaseProps {
  ...
  /** @default "outlined" */
  readonly variant?: TInputVariant;
